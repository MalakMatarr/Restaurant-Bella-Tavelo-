...
<body class="dark-page">
    ...
    <header class="navbar">
        ...
        <div class="nav-container">
            ...
            <nav class="nav-links">
                ...
                <a href="${pageContext.request.contextPath}/ManageFoodServlet"> Manage Food </a>

                <a class="active" href="${pageContext.request.contextPath}/ManageCategoriesServlet"> Categories </a>
    ...
    <main class="page-section">
        ...
        <section class="container" style="margin-top:30px;">
            ...
            <form class="form-card" action="${pageContext.request.contextPath}/ManageCategoriesServlet" method="post" style="margin-bottom:36px;">
                        ...
                        <c:forEach var="cat" items="${categories}">
                            ...
                            <tr id="view-row-${cat.categoryId}">
                                ...
                                <td>
                                    ...
                                    <form action="${pageContext.request.contextPath}/ManageCategoriesServlet" method="post" style="display:inline;"
                            ...
                            <tr id="edit-row-${cat.categoryId}" style="display:none;">
                                <td colspan="3">
                                    <form action="${pageContext.request.contextPath}/ManageCategoriesServlet" method="post" style="display:flex;gap:14px;align-items:flex-end;flex-wrap:wrap;">

    ...
    <header class="navbar">
        ...
        <div class="nav-container">
            ...
            <nav class="nav-links">
                ...
                <a class="active" href="${pageContext.request.contextPath}/ViewOrdersServlet"> Orders </a>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="order" items="${orders}">
                            <tr>
                                ...
                                <td>${order.addonsSummary}</td>
                                <td class="price">RM <fmt:formatNumber value="${order.totalAmount}" minFractionDigits="2" maxFractionDigits="2"/></td>
                                <td><fmt:formatDate value="${order.orderDate}" pattern="dd MMM yyyy, HH:mm"/></td>
                                <td>
                                    <form action="${pageContext.request.contextPath}/ViewOrdersServlet" method="post" style="display:flex;gap:8px;align-items:center;">

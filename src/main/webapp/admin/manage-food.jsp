    ...
    <main class="page-section">
        ...
        <section class="container" style="margin-top:30px;">
            ...
            <div style="display:flex;justify-content:flex-end;margin-bottom:20px;">
                <a href="${pageContext.request.contextPath}/AddFoodServlet" class="btn-primary"> + Add Food </a>
            </div>
                    ...
                    <tbody>
                        ...
                        <c:forEach var="item" items="${menuItems}">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/EditFoodServlet?id=${item.itemId}" style="color:var(--gold);font-weight:700;margin-right:14px;"> Edit </a>
                                    <a href="${pageContext.request.contextPath}/DeleteFoodServlet?id=${item.itemId}"
